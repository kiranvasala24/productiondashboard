          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`${inputBase} ${submitted && error ? inputError : ''}`}
              />
            </div>
            {submitted && error && <p className="text-destructive text-xs mt-1">{error}</p>}
          </div>

          <button type="button" onClick={() => navigate('/login')} className="flex items-center gap-1 text-sm text-card-foreground hover:text-primary transition-colors">
